...
namespace Lab51
{
    public class Coworker
    {
        ...
        private int Checkhours(string hours)
        {
            int result = 0;
        ...
        public void Add()
        {
            ...
            if (Console.ReadKey().Key == ConsoleKey.Enter)
            {
                using (StreamWriter f = new StreamWriter("C:\\Users\\s\\RiderProjects\\Lab51\\Lab51\\Coworker.txt",
                    true))
                    f.WriteLine("{0,-31}{1,-16}{2,-15}{3,-5}{4,-20}", add.Pib, add.position, add.date, add.hours,
                        add.project);
                ...
                using (StreamWriter f = new StreamWriter("C:\\Users\\s\\RiderProjects\\Lab51\\Lab51\\Coworker.txt"))
                    for (int i = 0; i < length; i++)
                    {
                        if (i != number - 1) f.WriteLine(str[i]);
                            ...
                            f.WriteLine("{0,-31}{1,-16}{2,-15}{3,-5}{4,-20}", edit.Pib, edit.position, edit.date,
                                edit.hours, edit.project);
                    }
